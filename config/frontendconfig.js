...
const FRONTEND_CONFIG = {
  ...
  staging: {
    ...
    FRONTEND_URL: 'https://staging.dailyvaibe.com',
    CLIENT_URL: 'https://staging.dailyvaibe.com',
    ADMIN_URL: 'https://staging-admin.dailyvaibe.com',
    ALLOWED_ORIGINS: [
      'https://staging.dailyvaibe.com',
      'https://staging-admin.dailyvaibe.com',
      'https://staging-api.dailyvaibe.com'
    ]
  },
  development: {
