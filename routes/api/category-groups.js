...
const GROUP_INFO = {
  'world': { name: 'World', description: 'Breaking news and global coverage', color: '#2563eb', icon: '🌍' },
  'counties': { name: 'Counties', description: 'Regional news coverage across Kenya', color: '#3498db', icon: '🏢' },
  'politics': { name: 'Politics', description: 'Political news and analysis', color: '#e74c3c', icon: '🏛️' },
  'business': { name: 'Business', description: 'Business, economy and finance news', color: '#2ecc71', icon: '💼' },
  'opinion': { name: 'Opinion', description: 'Editorials and commentary', color: '#9b59b6', icon: '💭' },
  'sports': { name: 'Sports', description: 'Sports news and analysis', color: '#f39c12', icon: '⚽' },
